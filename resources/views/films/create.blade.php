        ...
        <div class="col-lg-7">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5><i class="bi bi-plus-circle me-2"></i>Ajouter un film</h5>
                    ...
                    <form action="{{ route('films.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                   id="title" name="title" value="{{ old('title') }}" placeholder="Ex: Inception">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('releaseYear') is-invalid @enderror"
                                       id="releaseYear" name="releaseYear" value="{{ old('releaseYear') }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('originalLanguageId') is-invalid @enderror"
                                       ...
                                       value="{{ old('originalLanguageId', 1) }}" min="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('rentalDuration') is-invalid @enderror"
                                       ...
                                       value="{{ old('rentalDuration', 3) }}" min="1">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('length') is-invalid @enderror"
                                       id="length" name="length" value="{{ old('length') }}" min="1" placeholder="120">
